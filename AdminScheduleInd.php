    ...
    <div id="login">
      <div id="form">
		...
		<!-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% -->
	      ...
	      <input id="Date" type="date" name="Date" placeholder="mm/dd/yyyy" min="2015-12-01" max="2016-12-31" required autofocus> (mm/dd/yyyy)
	    </div>

		<!-- Select a time for the group advising session -->
        ...
        <input type="checkbox" name="time[]" value="15:30:00"> 3:30PM - 4:00PM <br>
			...
			<!-- Select majors for the group advising session -->
      ...
      <div class="field">
        <label for="Majors">Majors</label>
          ...
          <input type="checkbox" name="major[]" value="Chemical Engineering" checked>Chemical Engineering
	  			...
	  			<!-- Select day of the week for the group advising session -->
